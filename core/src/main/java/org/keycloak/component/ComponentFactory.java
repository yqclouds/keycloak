...
public interface ComponentFactory<CreatedType, ProviderType extends Provider> extends ProviderFactory<ProviderType>, ConfiguredProvider {
     ...
     */
    default void validateConfiguration(RealmModel realm, ComponentModel model) throws ComponentValidationException {
     ...
     */
    default void onUpdate(RealmModel realm, ComponentModel oldModel, ComponentModel newModel) {
     ...
     */
    default void preRemove(RealmModel realm, ComponentModel model) {
