 ...
 * @version $Revision: 1 $
 */
@Component("HardcodedUserSessionAttributeMapper")
@ProviderFactory(id = "hardcoded-user-session-attribute-idp-mapper", providerClasses = IdentityProviderMapper.class)
