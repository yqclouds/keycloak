...
public interface WebAuthnConstants {
    ...
    // EventModel key for credential id generated by navigator.credentials.create()
    final String PUBKEY_CRED_ID_ATTR = "public_key_credential_id";

    // EventModel key for Public Key Credential's user-editable metadata
    final String PUBKEY_CRED_LABEL_ATTR = "public_key_credential_label";

    // EventModel key for Public Key Credential's AAGUID
