 ...
 * @version $Revision: 1 $
 */
@Component("OIDCRoleNameMapper")
@ProviderFactory(id = "oidc-role-name-mapper", providerClasses = ProtocolMapper.class)
public class RoleNameMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper {
    ...
    public AccessToken transformAccessToken(AccessToken token, ProtocolMapperModel mappingModel,
        ...
        if (appName != null) {
            AccessToken.Access access = roleResolveUtil.getResolvedClientRoles(clientSessionCtx, appName, false);
        ...
        if (newAppName == null) {
            access = roleResolveUtil.getResolvedRealmRoles(clientSessionCtx, true);
        } else {
            access = roleResolveUtil.getResolvedClientRoles(clientSessionCtx, newAppName, true);
        }
