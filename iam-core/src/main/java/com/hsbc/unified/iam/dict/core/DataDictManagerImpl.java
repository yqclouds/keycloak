 ...
 */
package com.hsbc.unified.iam.dict.core;

import com.hsbc.unified.iam.core.util.DBUtils;
import com.hsbc.unified.iam.dict.autoconfigure.DataDictProperties;
import com.hsbc.unified.iam.dict.core.repository.DataDictRepository;
import com.hsbc.unified.iam.fss.core.support.FileType;
...
public class DataDictManagerImpl implements DataDictManager {
    ...
    public DataDict getDataDict(final Long id) {
        return dataDictRepository.getOne(id);
    }
    ...
    public void delete(final Long id) {
        Optional<DataDict> optional = dataDictRepository.findById(id);
        if (!optional.isPresent()) {
            dataDictRepository.delete(optional.get());
            cache.evict(optional.get());
        }
    }
