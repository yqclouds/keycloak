...
public class Realm {
    ...
    protected Set<String> enabledEventTypes = new HashSet<>();
    ...
    protected Client masterAdminClient;
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    protected List<IdentityProvider> identityProviders = new ArrayList<>();
    ...
    protected Set<String> supportedLocales = new HashSet<>();
    @Column(name = "DEFAULT_LOCALE")
    protected String defaultLocale;
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<RealmAttribute> attributes = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<RealmRequiredCredential> requiredCredentials = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    List<UserFederationProvider> userFederationProviders = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<UserFederationMapper> userFederationMappers = new ArrayList<>();
    @OneToMany(fetch = FetchType.LAZY, cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<ClientScope> clientScopes = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<IdentityProviderMapper> identityProviderMappers = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<AuthenticatorConfig> authenticators = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<RequiredActionProvider> requiredActionProviders = new ArrayList<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "realm")
    Collection<AuthenticationFlow> authenticationFlows = new ArrayList<>();
    ...
    public void setRequiredCredentials(Collection<RealmRequiredCredential> requiredCredentials) {
    ...
    public void setDefaultRoles(Collection<Role> defaultRoles) {
    ...
    public void setDefaultGroups(Collection<Group> defaultGroups) {
    ...
    public Client getMasterAdminClient() {
        return masterAdminClient;
    }

    public void setMasterAdminClient(Client masterAdminClient) {
        this.masterAdminClient = masterAdminClient;
    }

    public List<UserFederationProvider> getUserFederationProviders() {
        return userFederationProviders;
    }

    public void setUserFederationProviders(List<UserFederationProvider> userFederationProviders) {
        this.userFederationProviders = userFederationProviders;
    }

    public Collection<UserFederationMapper> getUserFederationMappers() {
        return userFederationMappers;
    }

    public void setUserFederationMappers(Collection<UserFederationMapper> userFederationMappers) {
        this.userFederationMappers = userFederationMappers;
    }

    public Collection<RealmAttribute> getAttributes() {
        return attributes;
    }

    public void setAttributes(Collection<RealmAttribute> attributes) {
    ...
    public void addIdentityProvider(IdentityProvider entity) {
    ...
    public Collection<IdentityProviderMapper> getIdentityProviderMappers() {
        return identityProviderMappers;
    }

    public void setIdentityProviderMappers(Collection<IdentityProviderMapper> identityProviderMappers) {
        this.identityProviderMappers = identityProviderMappers;
    }

    public Collection<AuthenticatorConfig> getAuthenticatorConfigs() {
        return authenticators;
    }

    public void setAuthenticatorConfigs(Collection<AuthenticatorConfig> authenticators) {
        this.authenticators = authenticators;
    }

    public Collection<RequiredActionProvider> getRequiredActionProviders() {
        return requiredActionProviders;
    }

    public void setRequiredActionProviders(Collection<RequiredActionProvider> requiredActionProviders) {
        this.requiredActionProviders = requiredActionProviders;
    }

    public Collection<AuthenticationFlow> getAuthenticationFlows() {
        return authenticationFlows;
    }

    public void setAuthenticationFlows(Collection<AuthenticationFlow> authenticationFlows) {
    ...
    public Realm setDockerAuthenticationFlow(String dockerAuthenticationFlow) {
        this.dockerAuthenticationFlow = dockerAuthenticationFlow;
        return this;
    }

    public Collection<ClientScope> getClientScopes() {
        return clientScopes;
    }

    public void setClientScopes(Collection<ClientScope> clientScopes) {
