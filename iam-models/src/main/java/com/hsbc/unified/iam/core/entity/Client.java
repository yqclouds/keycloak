...
public class Client {
    ...
    protected Collection<ClientAttribute> attributes = new ArrayList<>();
    @ElementCollection
    ...
    protected Set<Role> scopeMapping = new HashSet<>();
    @OneToMany(cascade = {CascadeType.REMOVE}, orphanRemoval = true, mappedBy = "client")
    ...
    public Collection<ClientAttribute> getAttributes() {
        return attributes;
    }

    public void setAttributes(Collection<ClientAttribute> attributes) {
    ...
    public Set<Role> getScopeMapping() {
        return scopeMapping;
    }

    public void setScopeMapping(Set<Role> scopeMapping) {
