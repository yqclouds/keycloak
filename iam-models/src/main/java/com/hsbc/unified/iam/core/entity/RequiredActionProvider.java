...
@Entity
@NamedQueries({
        @NamedQuery(name = "deleteRequiredActionProviderByRealm", query = "delete from RequiredActionProvider action where action.realm = :realm"),})
public class RequiredActionProvider {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequiredActionProvider)) return false;

        RequiredActionProvider that = (RequiredActionProvider) o;
