...
public abstract class RequestAuthenticator {
    protected static final Logger LOG = LoggerFactory.getLogger(RequestAuthenticator.class);
    ...
    public AuthOutcome authenticate() {
        ...
        QueryParameterTokenRequestAuthenticator queryParamAuth = createQueryParamterTokenRequestAuthenticator();
        if (LOG.isTraceEnabled()) {
    ...
    protected QueryParameterTokenRequestAuthenticator createQueryParamterTokenRequestAuthenticator() {
